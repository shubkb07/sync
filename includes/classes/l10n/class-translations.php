...
class Sync_Translations {
	 ...
	 * @since 6.5.0
	 *
	 * @param Translation_Controller $controller I18N controller.
	 * @param string                    $textdomain Optional. Text domain. Default 'default'.
	 */
	public function __construct( Translation_Controller $controller, string $textdomain = 'default' ) {
