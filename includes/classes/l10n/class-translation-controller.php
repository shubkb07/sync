<?php
/**
 * I18N: Translation_Controller class.
 */
 ...
 * @since 6.5.0
 */
final class Translation_Controller {
	/**
	 * Current locale.
	 *
	 * @since 6.5.0
	 ...
	 *
	 * @since 6.5.0
	 * @var array<string, array<string, Translation_File[]>>
	 */
	 ...
	 *
	 * [ Filename => [ Locale => [ Textdomain => Translation_File ] ] ]
	 *
	 * @since 6.5.0
	 * @var array<string, array<string, array<string, Translation_File|false>>>
	 */
	 ...
	 *
	 * @since 6.5.0
	 * @var Translation_Controller|null
	 */
	 ...
	 */
	public static function get_instance(): Translation_Controller {
	...
	public function load_file( string $translation_file, string $textdomain = 'default', ?string $locale = null ): bool {
		...
		if (
			...
			$moe = Translation_File::create( $translation_file );
		...
		if ( ! $moe instanceof Translation_File ) {
			return false;
		}
	 ...
	 * @since 6.5.0
	 *
	 * @param Translation_File|string $file       Translation file instance or file name.
	 * @param string                     $textdomain Optional. Text domain. Default 'default'.
	...
	public function translate_plural( array $plurals, int $number, string $context = '', string $textdomain = 'default', ?string $locale = null ) {
		...
		/** @var Translation_File $source */
		$source = $translation['source'];
		$num    = $source->get_plural_form( $number );

		// See \Sync_Translations::translate_plural().
	 ...
	 * @param string $textdomain Optional. Text domain. Default 'default'.
	 * @param string $locale     Optional. Locale. Default current locale.
	 * @return array{source: Translation_File, entries: string[]}|false {
	 *     Translations on success, false otherwise.
	 *
	 *     @type Translation_File $source Translation file instance.
	 ...
	 * @param string $textdomain Optional. Text domain. Default 'default'.
	 * @param string $locale     Optional. Locale. Default current locale.
	 * @return Translation_File[] List of translation files.
	 */
