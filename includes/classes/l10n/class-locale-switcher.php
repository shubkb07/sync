<?php
/**
 * Locale API: Locale_Switcher class
 */
...
class Locale_Switcher {
	...
	/**
	 * Filters the locale of the Sync installation.
	 *
	 * @since 4.7.0
	 *
	 * @param string $locale The locale of the Sync installation.
	 ...
	 *
	 * Loads the translations, changes the global `$locale` object and updates
	...
	private function change_locale( $locale ) {
		...
		Translation_Controller::get_instance()->set_locale( $locale );
