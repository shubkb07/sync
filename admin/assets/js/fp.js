// componentsToDebugString, getFullscreenElement, getUnstableAudioFingerprint, getUnstableCanvasFingerprint, getUnstableScreenFrame, getUnstableScreenResolution, getWebGLContext, hashComponents, isAndroid, isChromium, isDesktopWebKit, isEdgeHTML, isGecko, isSamsungInternet, isTrident, isWebKit: isWebKit, fpLoad, loadSources, murmurX64Hash128, prepareForSources, transformSource, withIframe,
...
function getUnstableCanvasFingerprint(n) {
  var e,
    t,
    r,
    o = !1,
...
var sources = {
  fonts: function () {
    var n = this;
    return withIframe(function (r, o) {
      var i = o.document;
      return e(n, void 0, void 0, function () {
  ...
  fontPreferences: function () {
    return (function (n, e) {
      void 0 === e && (e = 4e3);
      return withIframe(function (t, o) {
        var i = o.document,
          a = i.body,
          c = a.style;
        (c.width = "".concat(e, "px")),
  ...
  canvas: function () {
    return getUnstableCanvasFingerprint(isWebKit() && E() && C());
  },
  osCpu: function () {
  ...
  screenResolution: function () {
    if (!(isWebKit() && E() && C())) return getUnstableScreenResolution();
  },
      ...
      for (var h = 0, p = t; h < p.length; h++) {
        ...
        if (
          !(
            ...
            ("WEBGL_polygon_mode" === b && (isChromium() || isWebKit()))
          )
        ) {
...
function Zn(n) {
  var e = (function (n) {
      ...
      if (isWebKit()) return !isDesktopWebKit() || (E() && C()) ? 0.3 : 0.5;
...
function componentsToDebugString(e) {
            ...
            case 1:
              return (
                ...
                (c = (function (n) {
                  ...
                  return {
                    get visitorId() {
                      return void 0 === e && (e = hashComponents(this.components)), e;
                    },
                    set visitorId(n) {
                      e = n;
                    },
                ...
                (r || (null == i ? void 0 : i.debug)) &&
                  console.log(
                    "Copy the text below to get the debug data:\n\n```\nversion: "
                      ...
                      .concat(e - o, "\nvisitorId: ")
                      .concat(c.visitorId, "\ncomponents: ")
                      .concat(componentsToDebugString(a), "\n```")
                  ),
                [2, c]
              );
          }
    ...
    e(this, void 0, void 0, function () {
      ...
      return t(this, function (t) {
        switch (t.label) {
          case 0:
            return (
              n.monitoring, (e = n.delayFallback), (r = n.debug), [4, prepareForSources(e)]
            );
          case 1:
            return (
              t.sent(),
              (o = (function (n) {
                return loadSources(sources, n, []);
              })({ cache: {}, debug: r })),
              [2, Fn(o, r)]
            );
        }
